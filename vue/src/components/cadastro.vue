<template>
  <div class="auth-page" data-testid="auth-page">
    ...
    <div class="auth-container" data-testid="auth-container">
      <h1 data-testid="title">SUPPLY AI</h1>
      <form @submit.prevent="handleCadastro" data-testid="register-form">
        <input
...
const handleCadastro = () => {
  ...
  if (senha.value.length < 6) {
    mensagem.value = { texto: 'A senha deve ter no mínimo 6 caracteres', erro: true }
    loading.value = false
    return
  }
  ...
  if (usuarios[emailNormalizado]) {
    mensagem.value = { texto: 'Este e-mail já está cadastrado', erro: true }
    loading.value = false
    return
  }
  ...
  mensagem.value = { texto: 'Cadastro realizado com sucesso! Redirecionando...', erro: false }
